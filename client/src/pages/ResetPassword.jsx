...
<input type="email" placeholder='Email-id' className='bg-transparent outline-none text-white' value={email} onChange={e=>setEmail(e.target.value)}  />
 ...
 <button className='w-full bg-gradient-to-r from-indigo-500 to-indigo-900 py-3 text-white rounded-full'>Submit</button>
</form>}
{!isOtpSubmitted && isEmailSent &&

<form onSubmit={onSubmitOtp}  className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
              <h1 className='text-white text-2xl text-center font-semibold mb-4'>Reset Password OTP</h1>
              <p className='text-center text-indigo-300 mb-6'>Enter the 6 digit OTP sent to your email-id.</p>
            ...
            <button className='w-full bg-gradient-to-r from-indigo-500 to-indigo-900 py-2.5 text-white rounded-full'>Submit</button>
            </form>}
{isOtpSubmitted && isEmailSent && 
